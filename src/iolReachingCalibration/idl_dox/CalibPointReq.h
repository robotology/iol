...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_CALIBPOINTREQ_H
#define YARP_THRIFT_GENERATOR_STRUCT_CALIBPOINTREQ_H
...
public:
    ...
    CalibPointReq(const std::string& result,
                  const double x,
                  const double y,
                  const double z);
    ...
    public:
        ...
        // Editor: edit
        bool edit(CalibPointReq& obj, bool dirty = true);
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_CALIBPOINTREQ_H
