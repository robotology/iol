\doxysection{Helper funtions to assist I\+OL demo}
\label{group__icub__iolHelper}\index{Helper funtions to assist IOL demo@{Helper funtions to assist IOL demo}}
A container collecting useful functions that help I\+OL accomplish its tasks.\hypertarget{group__icub__iolHelper_proto_sec}{}\doxysubsection{Protocol}\label{group__icub__iolHelper_proto_sec}
