...
Module that uses the information from the motion\+Cut module to select the recognized blob of interest. \mbox{\hyperlink{group__icub__blobSelector}{Blob Selector}} application.  
